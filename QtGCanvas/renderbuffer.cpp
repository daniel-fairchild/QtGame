...
RenderBuffer::RenderBuffer(bool depth_texture)
{
    ...
    _initFBO(depth_texture);
}

RenderBuffer::RenderBuffer(int aheight, int awidth, bool depth_texture)
{
...
void RenderBuffer::_initFBO(bool depth_texture)
{
